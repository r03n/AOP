...
public class OrganizerUI {
    ...
    public OrganizerUI(Organizer o, MainGUI app) {
        ...
        table.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                if (e.getClickCount() == 2) { 
                    ...
                    if (row != -1) openEventReport(app, o, (int)table.getValueAt(row, 0), (String)table.getValueAt(row, 1), (String)table.getValueAt(row, 3), (String)table.getValueAt(row, 4), (int)table.getValueAt(row, 5));
                }
            }
        });
        ...
        createBtn.addActionListener(e -> {
            ...
            while (true) {
                if (JOptionPane.showConfirmDialog(app.getFrame(), msg, "Create New Event", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
        ...
        deleteBtn.addActionListener(e -> {
            int row = table.getSelectedRow();
            if (row != -1 && JOptionPane.showConfirmDialog(app.getFrame(), "Delete this event?", "Confirm", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                JOptionPane.showMessageDialog(app.getFrame(), o.deleteEvent((int)table.getValueAt(row, 0))); refreshTable.run();
            }
        });
    ...
    private void openEventReport(MainGUI app, Organizer o, int eventId, String title, String date, String time, int capacity) {
        JDialog dialog = new JDialog(app.getFrame(), "Management: " + title, true);
